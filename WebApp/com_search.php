...
if(strlen($search_text1)>0 &&  strlen($search_text2)==0 && strlen($search_text3)==0){
   
    $query="select * from restaurant_dishes  where cuisine='$search_text1'";
...
?>
                ...
                if(strlen($search_text1)>0 &&  strlen($search_text2)>0 && strlen($search_text3)==0){
                    ...
                    $query="select * from restaurant_dishes  where cuisine='$search_text1' and category='$search_text2'";
                $result=mysqli_query($conn,$query) or trigger_error(mysqli_error($conn));
...
?>
 <?php
                if(strlen($search_text1)>0 &&  strlen($search_text2)>0 && strlen($search_text3)>0){
                    ...
                    $query="select * from restaurant_dishes  where cuisine='$search_text1' and category='$search_text2' and taste='$search_text3'";
                $result=mysqli_query($conn,$query) or trigger_error(mysqli_error($conn));
...
if(strlen($search_text1)==0 &&  strlen($search_text2)>0 && strlen($search_text3)==0){
    ...
    $query="select * from restaurant_dishes  where category='$search_text2'";
$result=mysqli_query($conn,$query) or trigger_error(mysqli_error($conn));
...
if(strlen($search_text1)==0 &&  strlen($search_text2)==0 && strlen($search_text3)>0){
    ...
    $query="select * from restaurant_dishes  where taste='$search_text3'";
$result=mysqli_query($conn,$query) or trigger_error(mysqli_error($conn));
...
if(strlen($search_text1)==0 &&  strlen($search_text2)>0 && strlen($search_text3)>0){
    ...
    $query="select * from restaurant_dishes  where  category='$search_text2' and taste='$search_text3'";
$result=mysqli_query($conn,$query) or trigger_error(mysqli_error($conn));
...
if(strlen($search_text1)>0 &&  strlen($search_text2)==0 && strlen($search_text3)>0){
    ...
    $query="select * from restaurant_dishes  where  cuisine='$search_text1' and taste='$search_text3'";
$result=mysqli_query($conn,$query) or trigger_error(mysqli_error($conn));
