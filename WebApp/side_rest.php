        ...
        <body id="page-top">
            ...
            <div id="wrapper">
                <ul class="sidebar navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="javascript:setContent('add_dish.php');" style="color:black">
                            <i style='margin:5px' class="fa fa-plus"></i><span>Add Dish</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="javascript:setContent('edit_dish.php');" style="color:black">
                            <i style='margin:5px' class="fa fa-edit"></i><span>Edit Dishes</span></a>
                    </li>
                   <li class="nav-item">
